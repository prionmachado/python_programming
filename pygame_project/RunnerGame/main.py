...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.walk_frames = [
            pygame.image.load('pygame_project/RunnerGame/player_walk_1.png').convert_alpha(),
            pygame.image.load('pygame_project/RunnerGame/player_walk_2.png').convert_alpha()
        ]
        self.jump_frame = pygame.image.load('pygame_project/RunnerGame/jump.png').convert_alpha()
        self.index = 0
        self.image = self.walk_frames[self.index]
        self.rect = self.image.get_rect(midbottom=(80, 300))
        self.gravity = 0
        self.jump_count = 0
        self.jump_sound = pygame.mixer.Sound('pygame_project/RunnerGame/jump.mp3')
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type, speed_boost=0):
        ...
        if type == 'fly':
            self.frames = [
                pygame.image.load('pygame_project/RunnerGame/Fly1.png').convert_alpha(),
                pygame.image.load('pygame_project/RunnerGame/Fly2.png').convert_alpha()
            ]
            self.y_pos = 210
            self.speed = 8 + speed_boost
        else:
            self.frames = [
                pygame.image.load('pygame_project/RunnerGame/snail1.png').convert_alpha(),
                pygame.image.load('pygame_project/RunnerGame/snail2.png').convert_alpha()
            ]
            self.y_pos = 300
...
test_font = pygame.font.Font('pygame_project/RunnerGame/Pixeltype.ttf', 50)
game_active = False
start_time = 0
score = 0
paused = False
...
# Sound
bg_music = pygame.mixer.Sound('pygame_project/RunnerGame/music.wav')
...
# Background
sky_surface = pygame.image.load('pygame_project/RunnerGame/Sky.png').convert()
ground_surface = pygame.image.load('pygame_project/RunnerGame/ground.png').convert()

# Visual assets
player_stand = pygame.image.load('pygame_project/RunnerGame/player_stand.png').convert_alpha()
...
heart_img = pygame.image.load('pygame_project/RunnerGame/heart.png').convert_alpha()
heart_img = pygame.transform.scale(heart_img, (30, 30))

shield_icon = pygame.image.load('pygame_project/RunnerGame/shield.png').convert_alpha()
